# SMM Weight Matrix Visualization
...
- Adjust weight sliders to see how θ̂ moves toward different moment conditions
- Weights are constrained to sum to 100%

## Usage
Open `weights.html` in any browser, or view the live demo above.
